...
class Test extends Component {
  ...
  addCust(event) {
    ...
    var request = new Request('https://www.bharathb04.com:3000/api/new-cust', {
        method: 'POST',
  ...
  delCust(event) {
    ...
    var request = new Request('https://www.bharathb04.com:3000/api/del-cust/' + data.cust_id, {
        method: 'DELETE',
        headers: new Headers({'Content-Type': 'application/json'}),
        body: JSON.stringify(data)
    });
  ...
  selCust(event) {
    ...
    var request = new Request('https://www.bharathb04.com:3000/api/sel-cust', {
        method: 'GET',
